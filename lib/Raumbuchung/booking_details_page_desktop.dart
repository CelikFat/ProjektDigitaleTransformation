...
class BookingDetailsPageDesktop extends StatefulWidget {
  final DateTime selectedDay;
  final String selectedTimeSlot;
  final String selectedRoom;

  const BookingDetailsPageDesktop(
    {
      super.key,
...
class BookingDetailsPageState extends State<BookingDetailsPageDesktop> {

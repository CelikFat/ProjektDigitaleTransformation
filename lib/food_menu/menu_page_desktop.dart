...
class MenuPageDesktop extends StatefulWidget {
  const MenuPageDesktop({super.key});

  @override
  State<MenuPageDesktop> createState() => _MenuPageState();
}

class _MenuPageState extends State<MenuPageDesktop> {
          ...
          if (index == 0) {
            ...
            return Column(
              ...
              children: [
                ...
                ...menu.$1.map((item) =>
                    Container(padding: const EdgeInsets.symmetric(vertical: 4), child: _buildMenuItem(item: item))),
              ],
            );
          } else {
  ...
  Future<Canteen> fetchCanteen() async {
    final response = await http.get(Uri.parse('https://www.my-stuwe.de/wp-json/mealplans/v1/canteens/645/'));
            ...
            children: [
              ClipRRect(
                ...
                child: SizedBox(
                  width: 120,
                  height: 120,
                  child: Center(child: Image.asset('assets/menu/coming_soon_medium.jpg')),
                ),
              ),
